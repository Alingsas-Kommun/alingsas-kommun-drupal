    ...
    $.fn.termReferenceMenu = function (options) {
        ...
        return this.each(function () {
            ...
            var init = function () {
                ...
                $this.find('.form-item').append('<div class="term-reference-menu"><div class="container"><ul><li>Ingen utvalda</li></ul></div><label for="organisation-container">Lägg till fler:</label><div class="selector"><ul name="0"></ul></div></div>');
            ...
            var delItem = function( object ) {
            	if(typeof object !== undefined && object.attr('name') !== undefined) {
	                ...
	                if($.inArray(tid, $this.items) >= 0) {
	                	...
	                	if($this.items.length <= 0) {
	                		$this.find('.container ul').append('<li ><span class="name">Ingen utvalda</span></li>');
	                	}
	                	rebuildMenu();
	                }
            	}
            	...
            	if(typeof object !== undefined && object.attr('name') !== undefined) {
            	  ...
            	  if($this.lock == 0) {
            		    if (typeof $this.cache[tid] !== "undefined" && $this.cache[tid].loaded === true) {
            		      ...
            		      $this.lock = 1;
            		      $.getJSON('/term-reference-menu/' + tid + '/get', function(data) {
            		        $this.lock = 0;
            		        if(!$this.cache[tid]) {
            		        	$this.cache[tid] = {};
            		        }
